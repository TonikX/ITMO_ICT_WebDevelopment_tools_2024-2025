...
Время выполнения: 3.23 секунд
Количество задач: 8
```

## Особенности реализации
- Использует `aiohttp` для асинхронных HTTP-запросов
- Все запросы выполняются в одном потоке
- `asyncio.gather()` для параллельного выполнения запросов
- Эффективное использование ресурсов при I/O операциях