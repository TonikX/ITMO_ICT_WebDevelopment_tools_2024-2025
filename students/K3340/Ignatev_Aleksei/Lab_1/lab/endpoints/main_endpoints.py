...
def publisher_update(publisher_id: int, publisher: Publisher_Default,
                     session=Depends(get_session)) -> Publisher_Default:
...
def wish_accept(book_id: int, acception: Acception, session=Depends(get_session),
