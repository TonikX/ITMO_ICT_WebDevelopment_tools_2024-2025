...
class DriverRepository(BaseRepository):
    ...
    async def update_driver(self, driver: Driver) -> Driver:
        driver_db = await self.session.get(DriverDB, driver.id)
        driver_db.first_name = driver.first_name
        driver_db.last_name = driver.last_name
        driver_db.passport_info = driver.passport_info
        driver_db.driver_class_id = driver.driver_class.id
        driver_db.work_experience_months = driver.work_experience_months
