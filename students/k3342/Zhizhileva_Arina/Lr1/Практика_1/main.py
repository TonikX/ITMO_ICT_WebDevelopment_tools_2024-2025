...
@app.post("/profession")
def warriors_create(profession: Profession) -> TypedDict('Response', {"status": int, "data": Profession}):
...
def warriors_get(profession_id: int) -> List[Profession]:
    return [profession for profession in profession_temp_bd if profession.get("id") == profession_id]
