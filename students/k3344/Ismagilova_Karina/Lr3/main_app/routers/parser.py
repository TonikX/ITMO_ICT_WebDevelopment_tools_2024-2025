...
from main_app.models.models import TripRealParser
...
@router.get("/parsed-trips")
def get_parsed_trips(session: Session = Depends(get_session)):
    trips = session.exec(select(TripRealParser)).all()
    return trips
