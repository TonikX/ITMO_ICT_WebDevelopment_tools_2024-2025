...
@router.get("/get_all", response_model=list[Hackathon])
def get_all(session=Depends(get_session)):
    return hackathon_controller.get_all_hackathons(session)


@router.get("/get_id/{hackathon_id}", response_model=HackathonFull)
...
@router.post("/create_hack", response_model=HackathonFull)
...
@router.patch("/update_id/{hackathon_id}", response_model=HackathonFull)
...
@router.delete("/delete-hackathon_id/{hackathon_id}")
